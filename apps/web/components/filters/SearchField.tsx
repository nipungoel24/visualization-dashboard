    ...
    <div className="relative">
      ...
      {draft !== "" && (
        <button
          ...
          className="absolute top-1/2 right-1.5 inline-flex h-6 w-6 -translate-y-1/2 cursor-pointer items-center justify-center rounded-sm text-foreground-muted transition-[background-color,color] duration-150 ease-out hover:bg-surface-muted hover:text-foreground"
        >
