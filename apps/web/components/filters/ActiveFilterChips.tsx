      ...
      {visible.map((chip) => (
        ...
        >
          ...
          <button
            ...
            className="inline-flex h-10 min-w-10 cursor-pointer items-center justify-center rounded-sm p-1 text-foreground-muted transition-[background-color,color] duration-150 ease-out hover:bg-border hover:text-foreground sm:h-8 sm:min-w-8 sm:p-0"
          >
